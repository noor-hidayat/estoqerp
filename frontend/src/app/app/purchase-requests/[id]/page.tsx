...
function PRBody({
  ...
  return (
    <>
      ...
      {/* Print view for PR — template menyesuaikan kertas: A4 biasa / Continuous 9.5 x 11 inch */}
        ...
        <div className="mx-auto w-[190mm] max-w-[190mm] bg-white p-[10mm] text-black">
          ...
          <div className="mt-4 grid grid-cols-2 gap-4 text-[11px]">
            <div className="space-y-1">
              <div className="flex"><span className="w-28 shrink-0 text-zinc-600">PR No.</span><span className="font-medium text-black">{pr.documentNo ?? (pr as any).prNo ?? formatId(pr.id)}</span></div>
        ...
        <div className="mx-auto w-full max-w-[8.9in] bg-white font-mono text-black" style={{ fontSize: "11px", lineHeight: 1.4 }}>
          ...
          <div className="flex items-start justify-between gap-4 border-2 border-black px-3 py-2">
            ...
            <div className="shrink-0 pt-1 text-right">
              <div className="text-[15px] font-bold tracking-widest">PURCHASE</div>
              <div className="text-[15px] font-bold tracking-widest">REQUEST</div>
            </div>
          </div>
          {/* Meta: PR NO / DATE / REQUESTER / DEPT */}
          <div className="grid grid-cols-2 gap-x-6 border-2 border-t-0 border-black px-3 py-2 text-[11px]">
            <div className="flex gap-2"><span className="w-[92px] shrink-0">PR NO</span><span className="shrink-0">:</span><span className="font-bold">{pr.documentNo ?? (pr as any).prNo ?? formatId(pr.id)}</span></div>
            ...
            <div className="flex gap-2"><span className="w-[92px] shrink-0">DEPT</span><span className="shrink-0">:</span><span className="truncate">{deptLabel((pr as any).department)}</span></div>
          </div>
          {/* Item table */}
